...
public class ElementServiceImpl implements ElementService {
    ...
    @Override
    public List<Element> findByElementNameNot(String elementName) {
        return elementRepository.findByElementNameNot(elementName);
    }

    @Override
    public List<Element> findByElementNameIgnoreCase(String elementName) {
